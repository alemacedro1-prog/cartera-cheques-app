...
En las tres tarjetas principales se destaca el importe completo en pesos y centavos (formato `$ 1.234.567,89`, sin abreviaturas), con la cantidad debajo. Los importes del resumen se suman con aritmética decimal; las tarjetas de recibos también muestran centavos en su importe secundario.
